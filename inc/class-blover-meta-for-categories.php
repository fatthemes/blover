...
class Blover_Meta_For_Categories {
		...
		public function new_term_image_field( $term ) {
				...
				<div class="form-field mfc-category-form-field">
					...
					<div class="options" name="mfc_category_image_imageholder">
							<button class="button" id="mfc_category_image_upload_button"><?php esc_html_e( 'Upload', 'blover' ); ?></button>
							<button class="button" id="mfc_category_image_remove_button"><?php esc_html_e( 'Remove', 'blover' ); ?></button>
					</div>
				</div>
		...
		public function edit_term_image_field( $term ) {
				...
				<th scope="row">
					<label for="taxonomy_image"><?php esc_html_e( 'Category Image', 'blover' ); ?></label>
				</th>
