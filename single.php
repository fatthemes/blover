...
get_header(); ?>
<?php $has_sidebar = get_theme_mod( 'single_post_sidebar', 1 );
	$is_active_sidebar = (is_active_sidebar( 'sidebar-1' ) ? '' : ' col-lg-offset-2' );
get_sidebar( 'top' );	
?>
<div class="row">
		<div id="primary" class="content-area<?php echo ( $has_sidebar ? ' col-lg-8' . $is_active_sidebar : ' col-lg-8 col-lg-offset-2' ); // WP XSS OK. ?>">
