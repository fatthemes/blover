...
function blover_scripts() {
	...
	wp_enqueue_style( 'blover-fonts', blover_fonts_url(), array(), null );
	...
	wp_localize_script( 'blover-scripts', 'blover', array(
 ...
 * Liveblog.
 */
require_once get_template_directory() . '/inc/liveblog.php';
